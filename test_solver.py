...
class Test(unittest.TestCase):
    ...
    def test_condense_supercells(self):
        ...
        compare(
            [r("1:a,b,c"), r("2:b,c,d"), r("0:c,e")],
            [R("1:a,b,c"), R("2:b,c,d"), R("0:c,e")],
            "a,b,c,d,e",
        )
        compare(
            [r("1:a,b,c"), r("2:b,c,d"), r("0:b,c,e,f")],
            [R("1:a,bc"), R("2:bc,d"), R("0:bc,ef")],
            "a,bc,d,ef",
        )
    ...
    def test_rule_reduce_metric(self):
        ...
        self.assertEqual(
            Reduceable(R("3:a,b,cde"), R("1:a,b")).metric(),
            Reduceable(R("3:a,b,c,d,e"), R("1:ab")).metric(),
        )
        ...
        self.assertTrue(
            Reduceable(R("4:a,b,c,d,e,f,g,h"), R("1:a,b,c,d")).metric()
            > Reduceable(R("4:a,b,c,d,e,f,g,h"), R("2:a,b,c,d")).metric()
        )
        self.assertTrue(
            Reduceable(R("4:a,b,c,d,e,f,g,h"), R("0:a,b,c,d")).metric()
            > Reduceable(R("4:a,b,c,d,e,f,g,h"), R("1:a,b,c,d")).metric()
        )
        self.assertEqual(
            Reduceable(R("4:a,b,c,d,e,f,g,h"), R("1:a,b,c,d")).metric(),
            Reduceable(R("4:a,b,c,d,e,f,g,h"), R("3:a,b,c,d")).metric(),
        )
        self.assertEqual(
            Reduceable(R("4:a,b,c,d,e,f,g,h"), R("0:a,b,c,d")).metric(),
            Reduceable(R("4:a,b,c,d,e,f,g,h"), R("4:a,b,c,d")).metric(),
        )
    ...
    def test_reduce_rules(self):
        ...
        self.assertEqual(
            reduce_rules([R("2:ab,cde,f,g"), R("1:f,g")]),
            set([R("1:ab,cde"), R("1:f,g")]),
        )
        self.assertEqual(
            reduce_rules([R("2:a,b,x"), R("1:b"), R("1:b,c")]),
            set([R("1:a,x"), R("1:b"), R("0:c")]),
        )
        # chained reduction
        self.assertEqual(
            reduce_rules([R("2:a,x,y,z"), R("2:a,b,x"), R("1:b"), R("1:b,c")]),
            set([R("1:a,x"), R("1:b"), R("0:c"), R("1:y,z")]),
        )
        # decomposition then reduction
        self.assertEqual(
            reduce_rules([R("1:a,b,c,d"), R("0:c,d,e")]),
            set([R("1:a,b"), R("0:c"), R("0:d"), R("0:e")]),
        )
        self.assertEqual(
            reduce_rules([R("3:a,b,c,d"), R("3:c,d,e")]),
            set([R("1:a,b"), R("1:c"), R("1:d"), R("1:e")]),
        )
    ...
    def test_ruleset_cross_eliminate_and_rereduce(self):
        ...
        compare(
            [R("2:a,b,c"), R("1:b,c,d"), R("1:c,d,e"), R("1:d,e,f"), R("1:e,f,g")],
            [
                [P("a1b1c0"), P("a1b0c1")],
                [P("b1c0d0"), P("b0c1d0")],
                [P("c1d0e0"), P("c0d0e1")],
        ...
        compare(
            [R("2:a,b,c,d"), R("1:a,b,x"), R("1:c,d,y")],
            None,
